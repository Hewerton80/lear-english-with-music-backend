...
const modelsInfo = {
  Song: ["id", "title", "slug", "url", "createdAt"],
...
const outputsInfo = {
  ...
  SongGroupBy: ["id", "title", "slug", "url", "createdAt", "_count", "_min", "_max"],
  ...
  SongCount: ["authors"],
  SongCountAggregate: ["id", "title", "slug", "url", "createdAt", "_all"],
  SongMinAggregate: ["id", "title", "slug", "url", "createdAt"],
  SongMaxAggregate: ["id", "title", "slug", "url", "createdAt"],
  AuthorCount: ["songs"],
...
const inputsInfo = {
  SongWhereInput: ["AND", "OR", "NOT", "id", "title", "slug", "url", "createdAt", "authors"],
  SongOrderByWithRelationInput: ["id", "title", "slug", "url", "createdAt", "authors"],
  SongWhereUniqueInput: ["id", "title", "slug"],
  SongOrderByWithAggregationInput: ["id", "title", "slug", "url", "createdAt", "_count", "_max", "_min"],
  SongScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "slug", "url", "createdAt"],
  ...
  SongCreateInput: ["id", "title", "slug", "url", "createdAt", "authors"],
  SongUpdateInput: ["id", "title", "slug", "url", "createdAt", "authors"],
  SongCreateManyInput: ["id", "title", "slug", "url", "createdAt"],
  SongUpdateManyMutationInput: ["id", "title", "slug", "url", "createdAt"],
  ...
  SongCountOrderByAggregateInput: ["id", "title", "slug", "url", "createdAt"],
  SongMaxOrderByAggregateInput: ["id", "title", "slug", "url", "createdAt"],
  SongMinOrderByAggregateInput: ["id", "title", "slug", "url", "createdAt"],
  ...
  SongCreateWithoutAuthorsInput: ["id", "title", "slug", "url", "createdAt"],
  ...
  SongUpdateWithoutAuthorsInput: ["id", "title", "slug", "url", "createdAt"],
